...
import com.FreeCodeUserJack.recipeProject.commands.NotesCommand;
import com.FreeCodeUserJack.recipeProject.commands.RecipeCommand;
import com.FreeCodeUserJack.recipeProject.domain.Difficulty;
...
public class RecipeCommandToRecipeTest {
    ...
    public void setUp() throws Exception {
        converter = new RecipeCommandToRecipe(new CategoryCommandToCategory(), new IngredientCommandToIngredient(
                new UnitMeasureCommandToUnitMeasure()), new NotesCommandToNotes()
        );
    }
