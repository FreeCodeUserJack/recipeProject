...
import com.FreeCodeUserJack.recipeProject.domain.*;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public DataLoader(RecipeRepository recipeRepository, CategoryRepository categoryRepository, UnitMeasureRepository unitMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        UnitMeasure teaspoonUom = tableSpoonUomOptional.get();
        ...
        guacRecipe.setSource("Home Cooking 101");
        guacRecipe.setUrl("https://guacamole.com");
        ...
        tacosRecipe.setSource("American Digest");
        tacosRecipe.setUrl("https://tacos.com");
