...
# connect to mysql and run as root user, WorkBench for Windows
#Create Databases
CREATE DATABASE sfg_dev;
CREATE DATABASE sfg_prod;

#Create database service accounts, IDENTIFIED is password, % means connect from any host
...
#Database grants, % means from any host
